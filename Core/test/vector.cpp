...
TEST_F(TestVector, UnaryPlus) {
    {
        ...
        EXPECT_EQ(+doubleVector2D::null(), doubleVector2D::null());
    }
}
...
TEST_F(TestVector, Addition) {
    {
        ...
        doubleVector2D double2D(10.);
        EXPECT_EQ(double2D + doubleVector2D::null(), doubleVector2D({10., 10.}));
    } {
        doubleVector2D double2D(10.);
        EXPECT_EQ(doubleVector2D::null() + double2D , doubleVector2D({10., 10.}));
    } {
        doubleVector2D double2D(10.);
...
TEST_F(TestVector, Multiplication) {
    {
        ...
        doubleVector2D double2D(10.);
        EXPECT_EQ(double2D * doubleVector2D::null(), doubleVector2D({0., 0.}));
    } {
        doubleVector2D double2D(10.);
        EXPECT_EQ(doubleVector2D::null() * double2D, doubleVector2D({0., 0.}));
    } {
        doubleVector2D double2D(10.);
