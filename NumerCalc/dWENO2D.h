...
public:
    ...
    T solve(const T& tOffsetZero,
            const T& tX_min_2_Y, const T& tX_min_1_Y, const T& tX_pl_1_Y, const T&tX_pl_2_Y,
            const T& tX_Y_min_2, const T& tX_Y_min_1, const T& tX_Y_pl_1, const T&tX_Y_pl_2,
            double tMaxAlpha) {
        T PlusX = approximate(
